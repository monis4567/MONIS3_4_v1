...
mxpro_ampl.plot.filename <- "qpcr603_Rhithropanopeus_harrisii.xls"
#mxpro_ampl.plot.filename <- "ampl_plot_qpcr694_Neomel_20190520.xls"
#files <- "ampl_plot_qpcr692_Neomel_20190513.xls"
files <- "qpcr603_Rhithropanopeus_harrisii.xls"
#files <- "ampl_plot_qpcr694_Neomel_20190520.xls"
#define primers used 

prim1 <- c("co1_F03","co1_R03","co1_P03")
prim2 <- c("co1_F01","co1_R01","co1_P02")
prim3 <- c("co1_F02","co1_R01","co1_P02")
...
#for (mxpro_ampl.plot.filename in files){
  ...
  genlet <- as.character(gsub(" ","",well.splt02$X4))
  #unique(genlet)
  df02$repl.symb <- paste(as.character(genlet),"_",df02$spc.abbr,sep="")
