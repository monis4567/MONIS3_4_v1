...
mxpro_ampl.plot.filename <- "qpcr602_Magallana_gigas.xls"
#mxpro_ampl.plot.filename <- "ampl_plot_qpcr694_Neomel_20190520.xls"
#files <- "ampl_plot_qpcr692_Neomel_20190513.xls"
files <- "qpcr602_Magallana_gigas.xls"
#files <- "ampl_plot_qpcr694_Neomel_20190520.xls"
#define primers used 
prim1 <- c("co1_F05","co1_R05","co1_P05")
prim2 <- c("co1_F06","co1_R06","co1_P06")
prim3 <- c("co1_F06","co1_R09","co1_P06")
prim4 <- c("co1_F07","co1_R06","co1_P06")
prim5 <- c("co1_F07","co1_R09","co1_P06")
prim6 <- c("co1_F10","co1_R06","co1_P06")
